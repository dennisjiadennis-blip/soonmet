...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.title": "About Local Insider",
    "about.slogan": "I’m the Local. I’m the Insider. Ask me anything.",
    ...
    "about.hero.subtitle": "your unique journey starts with a Local Insider.",
    ...
    "home.footer.powered": "Powered by Local Insider AI Engine",

    // Registration
    "reg.title": "Join Local Insider",
    ...
    "dashboard.back": "Back",
    "dashboard.title": "Local Insider Host Center",
  ...
  ja: {
    ...
    "about.hero.subtitle": "あなただけの旅は、Local Insiderから始まる。",
