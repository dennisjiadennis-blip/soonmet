  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-zinc-200 rounded-md flex items-center justify-center hover:bg-zinc-100"
        ),
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-zinc-100 rounded-md flex items-center justify-center"
        ),
